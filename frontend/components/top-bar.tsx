...
import { Search, Bell, Info, Plus, ChevronRight, Home, LayoutGrid, List as ListIcon, Star, StarOff } from 'lucide-react';
      ...
      <div className="flex-1 flex items-center justify-end gap-3">
        {selectedFile ? (
          ...
          <div className="flex items-center gap-2 animate-in fade-in slide-in-from-top-1 duration-200">
            ...
            <Button variant="secondary" size="sm" onClick={() => onMove(selectedFile!)}>
              Move
            </Button>
            ...
            {selectedFile!.isStarred ? (
              <Button variant="secondary" size="icon" className="h-9 w-9 text-yellow-500" onClick={() => onUnstar(selectedFile!)} title="Unstar">
                <Star className="w-4 h-4 fill-current" />
              </Button>
            ) : (
              <Button variant="secondary" size="icon" className="h-9 w-9" onClick={() => onStar(selectedFile!)} title="Star">
